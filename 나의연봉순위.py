...
with st.expander("📊 통계 데이터 상세 보기", expanded=True):
    ...
    if user_income is not None and user_income > 0 and user_percentile_estimate is not None:
        ...
        def highlight_row(s, index_to_highlight):
            ...
            return ['background-color: lightyellow' if v else '' for v in is_highlighted]
        ...
        # Display summary DataFrame without highlighting if no user input or invalid
